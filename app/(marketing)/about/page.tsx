    ...
    <>
      ...
      <section className="bg-bg py-20 md:py-28">
        <div className="max-w-[900px] mx-auto px-8">
          ...
          <h2 className="text-[1.8rem] md:text-[2.2rem] leading-tight font-serif text-fg mb-8">
            Brett Bilon
          </h2>

          {/* Bio — two-column on desktop for readability */}
          <div className="columns-1 md:columns-2 gap-12 space-y-4 text-body text-fg/80">
            <p>
