...
export default function MatterNewIPTransferPage() {
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-[14px] text-[#5A5A5A] mt-1">
          Complete the steps below to assign intellectual property to your corporation.
        </p>
      </div>

      <IPTransferWizard matterId={matterId} />
    </div>
  )
}
