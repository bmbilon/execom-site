...
export interface AssistanceItem {
  ...
  /** Provenance: NULL or 'manual' = user-entered; 'recalc_pipeline' = generated by recalculation engine */
  generated_by: string | null
  /** FK to recalc_runs.id — which run created/updated this row */
  recalc_run_id: string | null
}
...
// ── Recalculation pipeline types (migration 008) ──
